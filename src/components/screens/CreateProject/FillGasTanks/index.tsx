...
export default function FillGasTanks({ gasTanks }: Props) {
    return (
        <Box p="5">
            ...
            <br />
            <Text variant={'heading3Regular'} color={'black.1'}>
                Your gas tanks are deployed on the same network as your
                contracts.
            </Text>
            <br />
            ...
            {gasTanks.map((gasTank, index) => {
                return (
                    <React.Fragment key={gasTank.gas_tank_id}>
                        <GasTankFiller

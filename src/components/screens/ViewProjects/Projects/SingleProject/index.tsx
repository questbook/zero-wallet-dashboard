            ...
            <Flex>
                ...
                >
                    <Text
                        ...
                        variant='code'
                    >
                        const zeroWalletConnectorOptions: ZeroWalletConnectorOptions =  &#x2775; jsonRpcProviderUrls: &#x2775;5: `https://eth-goerli.g.alchemy.com/v2/${process.env.NEXT_PUBLIC_ALCHEMY_API_KEY}`,    &#x2775;,    store: &rsquo;browser&rsquo;,    zeroWalletServerDomain: process.env.NEXT_PUBLIC_BACKEND_DOMA
                    </Text>
